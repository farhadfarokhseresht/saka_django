"""
Django settings for sakalab project.
...
SECRET_KEY = '=0zsv+wp3tqmv&))rw4vn)3d7n!0s5w-_y=&g_sn+u-6jx0r-i'
...
WSGI_APPLICATION = 'sakalab.wsgi.application'
